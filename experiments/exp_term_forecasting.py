...
class Exp_Long_Term_Forecast(Exp_Basic):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    ...
                    if self.args.output_attention:
                        ...
                        outputs, dec_out_time, dec_out_vari = self.model(batch_x)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            # flops, params = get_model_complexity_info(self.model, (96,321), as_strings=False, print_per_layer_stat=False)
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.use_amp:
                    ...
                    loss = criterion(outputs, batch_y) + contrastive_loss(dec_out_time, dec_out_vari) + loss1
